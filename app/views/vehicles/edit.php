...
<div class="bg-white rounded-lg shadow-lg p-6">
    <form method="POST" action="<?php echo BASE_URL; ?>/vehicles/update/<?php echo $vehicle['id']; ?>" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="plate" required
                           value="<?php echo htmlspecialchars($vehicle['plate']); ?>"
                ...
                <div>
                    ...
                    <select name="vehicle_type" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        <option value="auto" <?php echo $vehicle['vehicle_type'] === 'auto' ? 'selected' : ''; ?>>Automóvil</option>
                        <option value="moto" <?php echo $vehicle['vehicle_type'] === 'moto' ? 'selected' : ''; ?>>Motocicleta</option>
                        <option value="camioneta" <?php echo $vehicle['vehicle_type'] === 'camioneta' ? 'selected' : ''; ?>>Camioneta</option>
                        <option value="camion" <?php echo $vehicle['vehicle_type'] === 'camion' ? 'selected' : ''; ?>>Camión</option>
                        <option value="otro" <?php echo $vehicle['vehicle_type'] === 'otro' ? 'selected' : ''; ?>>Otro</option>
                    </select>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="owner_address"
                           value="<?php echo htmlspecialchars($vehicle['owner_address']); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
        ...
        <div class="border-t pt-6">
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                          placeholder="Cualquier observación adicional sobre el vehículo"><?php echo htmlspecialchars($vehicle['notes']); ?></textarea>
            </div>
        </div>
